...
describe('FilterBar Component', () => {
  ...
  describe('Error Handling', () => {
    test('handles bulk action errors gracefully', async () => {
      const selectedThreadIds = ['thread1'];
      mockOnBulkAction.mockRejectedValue(new Error('Network error'));
      ...
      await waitFor(() => {
        expect(mockOnBulkAction).toHaveBeenCalled();
      });
  ...
  describe('Accessibility', () => {
    test('has proper aria labels and roles', () => {
      ...
      expect(activeButton).toHaveAttribute('role', 'button');
      expect(deletedButton).toHaveAttribute('role', 'button');
    });
